import Toast from "../../class/Toast/Toast";
import princing from "../../constants/old-pricing";
import { getSquareFootRangeDetails } from "../../utils/squareFootUtils";
import servicesData, { details, extraRooms, frequencyPopupDetails } from "../../constants/services";
import Popup from "../../class/Popup/Popup";
          ...
          for (let extraRoom of extras[key]) {
            ...
            extraDiv.innerHTML = `
              ...
              <div class="d-flex g-10">
                ...
                <span style="color: var(--color-gray-4)" class="weight-600">$${value}</span>
              </div>
            `;
